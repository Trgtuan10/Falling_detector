...
weigths = torch.load('/home/trgtuan/OneDrive/My Git/Falling_detector/yolov7-w6-pose.pt', map_location=device)
    ...
    if ret:
        ...
        for idx in range(output.shape[0]):
            ...
            if left_shoulder_y > left_foot_y - len_factor and left_body_y > left_foot_y - (len_factor / 2) and left_shoulder_y > left_body_y - (len_factor / 2):
                ...
                filename = "/home/trgtuan/OneDrive/My Git/Falling_detector/trongtuan.png"
